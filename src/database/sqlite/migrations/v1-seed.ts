...
export const v1Seed = `
  ...
  INSERT INTO exercises (block_id, name, reps, time_seconds, weight, sets, rest_time, exercise_type, config_type, sets_data, position) VALUES
    ...
    -- Workout 4: HIIT Cardio Mix - with some COMPLEX exercises
